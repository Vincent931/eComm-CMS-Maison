...
@-moz-document url-prefix(){
  ...
  <title>Page de présentation du produit publicité(1) de vincent-dev-web</title>
  <meta name="description" content="Nous présentons ce produit sur option dans la configuration admin du Ecommerce vincent-dev-web."/>
</head>
...
if(isset($_SESSION['message'])){echo '<h3 style="text-align:center;color:red">'.$_SESSION['message'].'</h3>';$_SESSION['message']="";}
	...
	$i=0;
?>
<!----><?php $req31=$bdd1->query('SELECT * FROM publicite1');
