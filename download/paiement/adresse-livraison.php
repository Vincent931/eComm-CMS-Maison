			  ...
			  if(isset($_POST['prenom']) AND !empty($_POST['prenom'])){
				$prenom = htmlspecialchars($_POST['prenom']);
                  ...
                  if(isset($_POST['international']) AND $_POST['international']=='international_oui'){
                    ...
                    } else { $_SESSION['message']="Vous devez remplir le champs Région ou Province pour une vente à l'international."; header("Location:index.php");}
                  } else {
                    //key
                      $longueurKey = 19;
                      $key = "";
                ...
                } else {$_SESSION['message']="Vous devez remplir le champs Pays.";header("Location:index.php");}
              } else {$_SESSION['message']="Vous devez remplir le champs Ville.";header("Location:index.php");}
            } else {$_SESSION['message']="Vous devez remplir le champs Code Postal.";header("Location:index.php");}
          } else {$_SESSION['message']="Vous devez remplir le champs Adresse.";header("Location:index.php");}
        } else {$_SESSION['message']="Vous devez remplir le champs Prénom.";header("Location:index.php");}
      } else {$_SESSION['message']="Vous devez remplir le champs Nom.";header("Location:index.php");}
    } else { $_SESSION['message']="Vous devez entrez une adresse e-mail.";header("Location:index.php");}
  } else {$_SESSION['message']="Quelquechose s'est mal passé, CGV ? International(champs Région ou Province)?"; header("Location:index.php");}
...
<div id="containair">
     ...
     <div id="banniere_select"><span id="span_select">Livraison</span></div>
...
<div id="ind_paie_h1h4">
        <h1>Paiement</h1>
			<h4><?php if(isset($_SESSION['message1'])){echo $_SESSION['message1']; $_SESSION['message1']="";} ?></h4>
      <h4>Etape 2/3 - Adresse de Livraison</h4>
</div>
<section>
   	<article>
   		
</br>
		<form method="POST" action="adresse-livraison-list.php">
			<div id="ind_paie_bloc">
				...
				<p><label for="prenom_livr" class="heading">Prénom </label>
				<input type="text" name="prenom_livr" id="prenom_livr" value="<?php echo htmlspecialchars($donnees['prenom_livr']); ?>"/></p>

        <p><label for="nom_livr" class="heading">Nom </label>
        <input type="text" name="nom_livr" id="nom_livr" value="<?php echo htmlspecialchars($donnees['nom_livr']); ?>"/></p>
				
				<p><label for="societe_livr" class="heading">Société </label>
				<input type="text" name="societe_livr" id="societe_livr" value="<?php echo htmlspecialchars($donnees['societe_livr']); ?>"/></p>

				<p><label for="adresse1_livr" class="heading">Adresse </label>
				<input type="text" name="adresse1_livr" id="adresse1_livr" value="<?php echo htmlspecialchars($donnees['adresse1_livr']); ?>"/></p>
				
				<p><label for="adresse2_livr" class="heading">Complément d'adresse </label>
				<input type="text" name="adresse2_livr" id="adresse2_livr" value="<?php echo htmlspecialchars($donnees['adresse2_livr']); ?>"/></p>
				
				<p><label for="code_postal_livr" class="heading">Code Postal </label>
				<td><input type="text" name="code_postal_livr" id="code_postal_livr" value="<?php echo htmlspecialchars($donnees['code_postal_livr']); ?>"/></td></tr>
				
				<p><label for="ville_livr" class="heading">Ville </label>
				<input type="text" name="ville_livr" id="ville_livr" value="<?php echo htmlspecialchars($donnees['ville_livr']); ?>"/></p>

        <p><label for="province_livr" class="heading">Région ou province (International) </label>
        <input type="text" name="province_livr" id="province_livr" value="<?php echo htmlspecialchars($donnees['stateOrProvince_livr']); ?>"/></p>
        <input type="hidden" name="international" value="<?php if($_POST['international']=='international_oui'){echo 'international_oui';}else{echo '';}?>"/>

        <p><label for="pays_livr" class="heading">Pays </label>
        <select name="pays_livr" id="pays_livr">
  ...
  <option value = "ZW"> Zimbabwe </option>
				...
				<p><label for="inp_adr_livr" class="heading"> </p>
				<input type="submit" value="Valider" id="inp_adr_livr" onclick="change();"/></p>
			</div>
		</form>
	</article>
</section>
