...
$acheteurV=urldecode($_GET['mail']);

$req3= $bdd->prepare('SELECT * FROM compte WHERE mail=?');
$req3->execute(array($acheteurV));
$donnees4=$req3->fetch();
$adresseClient1 = htmlspecialchars($donnees4['nom_livr']);
$adresseClient1.=' ';
$adresseClient1.=htmlspecialchars($donnees4['prenom_livr']);
$adresseClient1.=' ';
$adresseClient1.=htmlspecialchars($donnees4['societe_livr']);
$adresseClient1.=' ';
$adresseClient1.=htmlspecialchars($donnees4['adresse1_livr']);
$adresseClient1.=' ';
$adresseClient1.=htmlspecialchars($donnees4['adresse2_livr']);
$adresseClient1.=' ';
$adresseClient1.=htmlspecialchars($donnees4['code_postal_livr']);
$adresseClient1.=' ';
$adresseClient1.=htmlspecialchars($donnees4['ville_livr']);
$adresseClient1.=' ';
if(isset($donnees4['stateOrProvince_livr'])AND !empty($donnees4['stateOrProvince_livr'])){$adresseClient1.=htmlspecialchars($donnees4['stateOrProvince_livr']);$adresseClient1.=' ';}
$adresseClient1.=htmlspecialchars($donnees4['pays_livr_string']);
