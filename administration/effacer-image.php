...
While($donnees=$req->fetch())
{
  ...
  if(isset($donnees['intitule']) AND $donnees['intitule']=='labelF'){
    ?><p><img style="width:165px" src="../logo.png"/> Nom de l'image : <?php echo $donnees['nom']; ?></p>
  ...
  ?>
  <p><img style="width:200px" src="../publicimgs/<?php echo $donnees['nom'];?>"/> Nom de l'image : <?php echo $donnees['nom']; ?></p>

  <p>Description : <?php echo $donnees['description'];?> ---- <a style="text-decoration:underline" href="effacer-image.post.php?id=<?php echo urlencode($donnees['id']); ?>">Effacer cette image</a></p>
  </br>
  <?php
}
}
