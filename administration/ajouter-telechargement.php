...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
  ...
  <?php require 'menu-haut.php';?>
			...
			<h2 style="text-align:center">Ajouter 1 téléchargement au listing produit</h2>
...
<br><br>
			<form style="width:550px;margin:auto;text-align:right" id="ch_form" name="ch_form" method="POST" action="ajouter-telechargement.list.php">

				<p><label style="color:blue" for="telechargement">Nom du téléchargement</label>
				<p><input id="voir3" type="button" name="voir3" value="Voir"/></p>
				<p><input id="cacher3" type="button" name="cacher3" value="Cacher"/></p>
				<input type="text" name="cle_down" id="cle_down"/></p>
				<br>
