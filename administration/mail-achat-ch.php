...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
  ...
  <?php require 'menu-haut.php';?>
			...
			<h2 style="text-align:center">Changer email Achat (client) (non validé pour l'instant)</h2>
...
<?php if(isset($_SESSION['message'])){echo '<h3 style="text-align:center;color:red">'.$_SESSION['message'].'</h3>';$_SESSION['message']="";} ?>
      ...
      <?php 
      $req20=$bdd1->query('SELECT vente FROM mails');
      $mail=$req20->fetch();
      $mail_achat=$mail['vente'];
 require 'bank-img-vid-mp3-7.php';?>
<br><br>
<form method="post" name="ch_form" id="ch_form" action="mail-achat-ch.list.php">
