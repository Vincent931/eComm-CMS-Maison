...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
  ...
  <?php require 'menu-haut.php';?>
      ...
      <h2 style="text-align:center">Changer Landing Page</h2>
...
$req=$bdd1->query('SELECT * FROM landingP');
$menu=$req->fetch();
...
<p>La landing-page est disponible à l'url: https://monsite.com/landing-page.php</p>
<?php require 'bank-img-vid-mp3.php';?>
<form action="landingP.list.php" name="ch_form" id="ch_form" method="post">
    <p style="color:blue">Landing Page</p>
