...
$mail = new  PHPMailer\PHPMailer\PHPMailer ;
    ...
    $mail->addAddress(htmlspecialchars($mail1), $nom_ste);     // Add a recipient
    ...
    $mail->Subject = "Validation commande ".$nom_ste;
    $mail->Body = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN"
	   			...
	   			<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="font-family:Verdana,Tahoma,verdana,tahoma,sans-serif">
					...
					<tr>
					<td style="text-align:center;margin:auto;width:300px"><img alt="'.$nom_ste.'-Bandeau-mail" src="'.$url_ste.'/publicimgs/'.$image.'"/></td>
					</tr>
					</table>
					</tbody>
					...
					<a style="text-decoration:none;border-radius:10px/10px;color:white;background-color:black;padding:4px;margin:auto;text-align:center" href="'.$url_ste.'/facture.php" alt="user">Accedez aux factures en cliquant ici</a>
					</td>
					</tr>
					</tbody>
					</table>
...
$mail->AltBody = $mail_vente.$url_ste.'/facture.php'.' cliquez ou ajouter dans votre navigateur.';
