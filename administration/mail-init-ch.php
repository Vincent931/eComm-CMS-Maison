...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
  ...
  <?php require 'menu-haut.php';?>
			...
			<h2 style="text-align:center">Changer email création de compte</h2>
...
<?php if(isset($_SESSION['message'])){echo '<h3 style="text-align:center;color:red">'.$_SESSION['message'].'</h3>';$_SESSION['message']="";} ?>
      ...
      <?php 
      $req20=$bdd1->query('SELECT compte_creation FROM mails');
      $mail=$req20->fetch();
      $mail_init=$mail['compte_creation']; 
       require 'bank-img-vid-mp3-7.php';?>
       <br><br>
<form method="post" name="ch_form" id="ch_form" action="mail-init-ch.list.php">
