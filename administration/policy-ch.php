...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
  ...
  <?php require 'menu-haut.php';?>
			...
			<h2 style="text-align:center">Changer Politique de confidentialité</h2>
...
$req=$bdd1->query('SELECT * FROM politique');
$menu=$req->fetch();
...
<form action="policy-ch.list.php" name="ch_form" id="ch_form" method="post">
    <p style="color:blue">Page Politique de confidentialité</p>
    <input type="hidden" name="position" id="position"></input>
    <p><input id="grey_color" onclick="pos()" type="submit" Value="Enregistrer"/></p>
