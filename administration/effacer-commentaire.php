...
<?php require 'head.php';?>
  ...
  <?php require 'menu-haut.php';?>
			...
			<h2 style="text-align:center">Effacer commentaire</h2>
...
?>
	...
	<table style="width:65%;margin:auto">
			...
			<p><em><a id="grey_color" style="border:1px solid black;color:black;text-decoration:none" href="effacer-commentaire.post.php?sujet=<?php echo htmlspecialchars(urlencode($donnees['id'])); ?>">Choisir ce sujet pour effacer un commentaire ...</a></em></p>
