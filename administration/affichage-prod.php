<form style="width:550px;margin:auto;text-align:right" name="id_modifierF<?php echo $i;?>" id="id_modifierF<?php echo $i;?>" method="POST" action="modification-produit.list.php">
...
<?php }?>
			...
			<?php if($mod>0){ ?><p style="text-align:right"><input style="text-align:right" type="submit" value="Modifier"/></p><?php } ?>
