...
<?php require 'head.php';?>
  ...
  <?php require 'menu-haut.php';?>
			...
			<h2 style="text-align:center">Configurer opennode</h2>
...
<?php if(isset($_SESSION['message'])){echo '<h3 style="text-align:center;color:red">'.$_SESSION['message'].'</h3>';$_SESSION['message']="";} ?>
			...
			<p>Vous pouvez ajouter les paiements en cryptos avec <span style="color:green">opennode</span> <a style="color:blue;text-decoration:underline" target="_blank" href="https://www.opennode.com/">ici</a></p>
			<br>
			<h4>opennode</h4>
			<p style="width:600px;margin:auto; text-align:left">Créez votre compte, téléchargez un svg de votre logo,(situé dans https://monsite.com/publicimgs/nomlogo.svg), ajoutez votre compte bancaire sur le site, lancez , Précisez l'adresse du svg et demander un merchant account, vous aurez une réponse dans les jours qui suivent.</p><?php $intitule="svg"; 
			...
			<?php $req=$bdd->query('SELECT * FROM opennode');
			$donnees=$req->fetch();
			?>
			<form method="post" action="opennode-config.php" style="text-align:right;width:600px; margin:auto">
