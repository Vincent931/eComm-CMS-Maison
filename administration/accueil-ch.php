...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
  ...
  <?php require 'menu-haut.php';?>
      ...
      <h2 style="text-align:center">Changer page Accueil</h2>
...
$req=$bdd1->query('SELECT * FROM accueil');
$menu=$req->fetch();
...
<form action="accueil-ch.list.php" name="ch_form" id="ch_form" method="post">
    <p style="color:blue">Page Accueil</p>
