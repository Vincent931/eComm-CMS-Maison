...
<div style="display:inline-block">
  <span style="display:block"><input id="voir1" type="button" name="voir1" value="image float"/></span>
  <input style="display:block;border:1px solid black;background-color:#DDE3E3;margin-top:5px;margin-bottom:5px;padding:5px;color:black;text-decoration:none" id="cacher1" type="button" name="cacher" value="CACHER"/>
</div>
<div style="display:inline-block">
  <span style="display:block"><input id="voir2" type="button" name="voir2" value="videos MP4"/></span>
  <input style="display:block;border:1px solid black;background-color:#DDE3E3;margin-top:5px;margin-bottom:5px;padding:5px;color:black;text-decoration:none" id="cacher2" type="button" name="cacher" value="CACHER"/>
</div>
<div style="display:inline-block">
  <span style="display:block"><input id="voir3" type="button" name="voir3" value="Musiques MP3"/></span>
  <input style="display:block;border:1px solid black;background-color:#DDE3E3;margin-top:5px;margin-bottom:5px;padding:5px;color:black;text-decoration:none" id="cacher3" type="button" name="cacher" value="CACHER"/>
</div>
  ...
  <div style="display:inline-block"><span style="margin-top:10px;margin-bottom:5px;padding:5px;background-color:#EFD5AB;display:block">ex Youtube</span>
    <a style="display:block;border:1px solid black;background-color:#DDE3E3;margin-top:5px;margin-bottom:5px;padding:5px;color:black;text-decoration:none" href="javascript:AddText('','<iframe  style=&quot;width: 298px; height: 298px&quot;  src=&quot;https://www.youtube.com/embed/y94CtKuGG_Q&quot; frameborder=&quot;0&quot; allow=&quot;accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture&quot; allowfullscreen></iframe>','');">youtube ex:</a>
  </div>
  
   <div style="display:inline-block"><span style="margin-top:10px;margin-bottom:5px;padding:5px;background-color:#EFD5AB;display:block">Fichiers</span>
   <a style="display:block;border:1px solid black;background-color:#DDE3E3;margin-top:5px;margin-bottom:5px;padding:5px;color:black;text-decoration:none"  href="window-file.php" onclick="window.open(this.href,'targetWindow','toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=250px,height=360'); return false;">Fichiers Bank</a>
  </div>
</div>