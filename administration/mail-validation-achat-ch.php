...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
  ...
  <?php require 'menu-haut.php';?>
			...
			<h2 style="text-align:center">Changer email validation Achat (client)</h2>
...
<?php if(isset($_SESSION['message'])){echo '<h3 style="text-align:center;color:red">'.$_SESSION['message'].'</h3>';$_SESSION['message']="";} ?>
      ...
      <?php 
      $req20=$bdd1->query('SELECT vente_validation FROM mail_vente_valid');
      $mail=$req20->fetch();
      $mail_achat=$mail['vente_validation'];
 require 'bank-img-vid-mp3-7.php';?>
<br><br>
<form method="post" name="ch_form" id="ch_form" action="mail-validation-achat-ch.list.php">
...
<fieldset style="width:950px;background:#8DC8FC;margin:auto">
	<?php require 'editeur-rep-mails.php'; ?>
  	...
  	<textarea style="width:950px; height:900px" rows="32" cols="90" name="message" id="message" wrap="virtual" onmouseover="this.focus();"><?php echo $mail_achat;?></textarea>
  </fieldset>
</form>
