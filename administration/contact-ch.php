...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
  ...
  <?php require 'menu-haut.php';?>
      ...
      <h2 style="text-align:center">Changer page Contact</h2>
...
$req=$bdd1->query('SELECT * FROM contactez');
$menu=$req->fetch();
...
<form action="contact-ch.list.php" name="ch_form" id="ch_form" method="post">
    <p style="color:blue">Page Contact</p>
