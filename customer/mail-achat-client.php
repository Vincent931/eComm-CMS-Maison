...
$mail = new  PHPMailer\PHPMailer\PHPMailer ;
    ...
    $mail->addAddress($mail1, $nom_ste);     // Add a recipient
    ...
    $mail->Subject = "Validation de votre commande sur ".$nom_ste;
    $mail->Body = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN"
   			...
   			<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="font-family:Verdana,Tahoma,verdana,tahoma,sans-serif">
				...
				<td style="text-align:center;width:300px"><img style="width:300px" alt="'.$nom_ste.'-Bandeau" src="'.$url_ste.'/publicimgs/'.$image.'"></td>
				</tr>
				</table>
				</tbody>
				...
				<td style="text-align:left;margin:auto;width:600px">Vous venez d\'acheter des produits sur '.$url_ste.', Veuillez patienter, <span style="color:blue">votre achat et votre facture seront bientot disponible:</span></td>
				</tr>
				</tbody>
				</table>
				...
				<tbody>
				<tr style="text-align:center;margin:auto">
				<td style="text-align:left;margin:auto;width:600px">Votre REFERENCE achat: <span style="color:blue">'.$reference.'</span></td>
				</tr>
				</tbody>
				</table>
				...
				<tbody>
				<tr style="text-align:center;margin:auto">
				<td style="text-align:left;margin:auto;width:600px">'.$mail_vente.'</td>
				</tr>
				</tbody>
				</table>
				...
				<tbody>
				<tr style="text-align:center;margin:auto">
				<td style="text-align:center;margin:auto"><a style="text-decoration:none;border-radius:10px/10px;color:white;background-color:black;padding:4px;text-align:center;margin:auto" href="'.$url_ste.'">'.$url_ste.'</a></td>
				</tr>
				</tbody>
				</table>
    ...
    $mail->AltBody = 'Vous venez de valider un achat sur '.$url_ste.', Veuillez patienter, votre achat et votre facture seront bientot disponible';
