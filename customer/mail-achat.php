...
$mail = new  PHPMailer\PHPMailer\PHPMailer ;
    ...
    $mail->Subject = "Vente initiée sur: ".$nom_ste;
    $mail->Body = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN"
   			...
   			<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="font-family:Verdana,Tahoma,verdana,tahoma,sans-serif">
				...
				<td style="text-align:center;width:300px"><img style="width:300px" alt="'.$nom_ste.'-Bandeau" src="'.$url_ste.'/publicimgs/'.$image.'">
				</tr>
				</table>
				</tbody>
				...
				<tbody>
				<tr>
				<td align="center">Une vente a été initiée, vérifiez si l\'achat est effectif et validez la vente après avoir cliqué sur le lien suivant:<br><br> <a style="text-decoration:none;border-radius:10px/10px;color:white;background-color:black;padding:4px;" href="'.$url_ste.'/administration/stock-factures.php" alt="user">'.$url_ste.'/administration/stock-factures.php'.'</a><br><br> LA REFERENCE: <span style="color:blue">'.$reference.'</span><br><br>Le paiement est de type: <span style="color:blue">'.$type_paie.'</span></td>
				</tr>
				</tbody>
				</table>
