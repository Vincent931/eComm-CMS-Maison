...
function affiche_toutM() {
    ...
    //efface tout
    /*
    $(".classe_100").width(320);
    $(".jeuxcw").width(320);
    $("#div_large").width(300);
    $("#h1_comment1").width(300);*/
    }
}
});
</script>
<div id="aff_block">
    ...
    <div id="deroulant">
        <div class="niveau1M">
            ...
            <li class="Mab123"><a class="Ma_panier1" style="text-decoration:none;text-align:center;margin:auto" id="MH11" href="Questions-reponses">Sujets/Accueil</a>
