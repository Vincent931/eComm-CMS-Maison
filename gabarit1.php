...
$pdf->template['infoDate']['color'] = array('r'=>100, 'g'=>100, 'b'=>100);
// client
...
$pdf->template['footer']['margin'] = array(270, 40, 0, 40);//270 du bord haut 40 droite et gauche
// entete de produit
$pdf->template['productHead']['fontFace'] = 'B';
$pdf->template['productHead']['color'] = array('r'=>100, 'g'=>100, 'b'=>100);
...
// entete des totaux
$pdf->template['totalHead']['lineHeight'] = 0.2;
$pdf->template['totalHead']['backgroundColor'] = array('r'=>100, 'g'=>100, 'b'=>100);
...
$pdf->template['traitEnteteProduit']['lineHeight'] = 0.2;
$pdf->template['traitEnteteProduit']['backgroundColor'] = array('r'=>100, 'g'=>100, 'b'=>100);
$pdf->template['traitEnteteProduit']['margin'] = array(80, 0, 0, 0);
// element personnalisé 2
$pdf->template['traitBas']['lineHeight'] = 0.2;
$pdf->template['traitBas']['backgroundColor'] = array('r'=>100, 'g'=>100, 'b'=>100);
